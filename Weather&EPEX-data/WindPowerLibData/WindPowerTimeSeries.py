...
ds = xr.open_dataset("data_Heibloem.grib", engine="cfgrib")
...
times = pd.date_range("2024-01-01", "2025-01-01", freq="h", tz="UTC")
...
temp_k = np.array(temp_series)
pressure = np.array(pressure_series)
...
production_normalized.to_csv("data_Heibloem_normalized_production.csv", header=True)
# %%
